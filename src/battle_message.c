...
const u8 gColor_SuperEffective[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 1 14 2}");
const u8 gColor_SuperEffectiveStab[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 3 14 4}");
const u8 gColor_NotVeryEffective[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 5 14 6}");
const u8 gColor_NotVeryEffectiveStab[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 7 14 8}");
const u8 gColor_NoEffect[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 9 14 10}");
const u8 gColor_NormalEffectiveStab[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 12 14 15}");
