...
const u8 gColor_SuperEffective[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 10 14 15}");
const u8 gColor_NotVeryEffective[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 9 14 15}");
const u8 gColor_NoEffect[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 8 14 15}");
